...
<section id="{{ $servicios['id'] ?? 'servicios' }}" x-data class="relative overflow-hidden bg-sand-50 py-20 lg:py-28" aria-labelledby="servicios-titulo">
    ...
    <div class="shell relative">
        <div class="reveal mx-auto max-w-2xl text-center" x-intersect.once="$el.classList.add('is-visible')">
            ...
            <h2 id="servicios-titulo" class="mt-5 font-display text-3xl font-semibold sm:text-4xl lg:text-[2.7rem]">{{ $servicios['title'] }}</h2>
