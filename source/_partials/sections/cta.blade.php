...
<section id="{{ $cta['id'] ?? 'llamado' }}" x-data class="relative" aria-labelledby="cta-titulo">
    <div class="bg-brand-gradient relative overflow-hidden">
        ...
        <div class="shell relative py-20 text-center lg:py-24">
            <div class="reveal mx-auto max-w-3xl" x-intersect.once="$el.classList.add('is-visible')">
                <h2 id="cta-titulo" class="font-display text-3xl font-semibold leading-tight text-white sm:text-4xl lg:text-[2.75rem]">{{ $cta['title'] }}</h2>
